...
public class TF{
	...
	*@return 文档的词频
	*/
	public static Map<String,Double> getTF(List<String> doc){
	...
	*@return 文档的词频
	*/
	public static Map<String,Double> getTF(Document doc){
	...
	*@return 文档的词频
	*/
	public static Map<String,Double> getTF(String[] doc){
		Map<String,Double> tf=new HashMap<String,Double>();
